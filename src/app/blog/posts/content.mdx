...
Replace the `public/images/avatars.jpg` file with your own avatar image. It is used on the `/about` page as well as on the dynamically generated `open-graph` images.
...
`const home = {
    label: "Home",
    title: "Gugus Widiandito's Portfolio",
    description: "Portfolio website showcasing my work as a Web Developer",
    headline: <>Web Developer and builder</>,
    subline: (
      <>
        I'm Gugus, a Web Developer at <InlineCode>FLY</InlineCode>, where I craft intuitive
